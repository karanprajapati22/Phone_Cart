          ...
          <div class="col-md-4 mb-3">
            ...
            <div class="card mt-3">
              <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap pointer active" onclick="window.location='viewcart.php'">
            ...
            <div class="col-md-8">
              ...
              <div class="row justify-content-center">
                <?php
                  ...
                  // include './admin/dbcontroller.php';
                  // $handle = new DBcontroller();
                  $query = "select * from `cart` where status='pending' and reg_id=(select reg_id from registration where email='" . $_SESSION['email'] . "')";
                        ...
                        <table class="table table-bordered mt-5">
                            ...
                            <tbody>
                                <?php
                                  $i = 1;
                                  foreach ($res as $row2) {
                                      $query = "select * from cart where status='pending' and reg_id=(select reg_id from registration where email='$mail') order by prod_id desc";
